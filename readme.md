...
Creates bitmap images to be used by TinyFont from a truetype font file.
...
| `-name` | string | <filename> | Name of font used in variable declaration. By default it will use the filename of the provided TTF. |
